            ...
            <div class="row ">
                <div class="col-2 ps-5 vpp-bg-dark vpp-admin-menu ">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item  vpp-dropdown ">
                            <a class="nav-link text-white vpp-link fs-5 hvr-underline-from-left " href="./san-pham.html">Sản phẩm</a>
                        ...
                        <li class="nav-item  vpp-dropdown ">
                            <a class="nav-link text-white vpp-link fs-5 hvr-underline-from-left " href="#">Khách hàng</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="col-12">
                            <div class="row" style=" height: 15vh;">
                                <div class="col-1  vpp-bd-btn p-3">
                                    <img src="../../assets/img/Logo.png" alt="img" style="width: 100%; height: 100%;">
                                </div>
                                <div class="col-11" style=" height: 15vh;">
                                    <div class="row p-2 m-0 ms-2 vpp-bd-btn h-100">
                                        ...
                                        <div class=" col-4 d-flex flex-column justify-content-between">
                                            <p>Ngày sinh: <span>10/11/2001</span></p>
                            ...
                            <div class="row m-0 ">
                                ...
                                <div
                                    ...
                                    <a href="#"
                                        ...
                                        <i class="fas fa-info vpp-text-pink " style="font-size: 2vw;"></i>
                                    </a>
                                ...
                                <div class="col-8">
                                    ...
                                    <h2>5</h2>
                                    <a href="#" class="vpp-link vpp-text-decoration">Xem chi tiết</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row m-0 ">
                                ...
                                <div
                                    ...
                                    <a href="#"
                                        class=" d-flex align-items-center justify-content-center bg-white vpp-bd-circle p-2 m-1 mb-2 "
                                        style="height: 5vw;width: 5vw">
                                        <i class="fas fa-check vpp-text-pink " style="font-size: 2vw;"></i>
                                    </a>
                            ...
                            <div class="row m-0 ">
                                ...
                                <div
                                    ...
                                    <a href="#"
                                        class=" d-flex align-items-center justify-content-center bg-white vpp-bd-circle p-2 m-1 mb-2 "
                                        style="height: 5vw;width: 5vw">
                                        <i class="fas fa-shopping-cart  vpp-text-pink " style="font-size: 2vw;"></i>
                                    </a>
