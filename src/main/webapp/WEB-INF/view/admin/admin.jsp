			...
			<div id="content ">
				<div class="row ">
					<div class="col-2 ps-5 vpp-bg-dark vpp-admin-menu ">
						<ul class="navbar-nav">
							...
							<li class="nav-item  vpp-dropdown "><a
								class="nav-link text-white vpp-link fs-5 hvr-underline-from-left "
								href="${pageContext.request.contextPath}/admin/donhang/">Đơn
									hàng</a></li>
							<li class="nav-item  vpp-dropdown "><a
								class="nav-link text-white vpp-link fs-5 hvr-underline-from-left "
								href="${pageContext.request.contextPath}/admin/sanpham/">Sản
									phẩm</a></li>

							<security:authorize access="hasAnyRole('ADMIN')">
								<li class="nav-item  vpp-dropdown "><a
									class="nav-link text-white vpp-link fs-5 hvr-underline-from-left "
									href="${pageContext.request.contextPath}/admin/nhanvien/">Nhân
										viên</a></li>

								<li class="nav-item  vpp-dropdown "><a
									class="nav-link text-white vpp-link fs-5 hvr-underline-from-left "
									href="${pageContext.request.contextPath}/admin/khachhang/">Khách
										hàng</a></li>
					...
					<div class="col-10 p-0">
						...
						<div
							class=" row m-0 p-3 ps-4 pe-3  d-flex justify-content-between">
							<div class="col-12">
									...
									<div class="col-11" style="height: 15vh;">
										<div class="row p-2 m-0 ms-2 vpp-bd-btn h-100">
											<div
												...
												<p>
													Mã nhân viên: <span>${nv.id}</span>
												</p>
												<p>
													Họ tên: <span>${nv.tenNV}</span>
												</p>
												<p>
											...
											<div
												...
												<p>
													Sđt: <span>${nv.sdt}</span>
												</p>
												<p>
													Chức vụ: <span>${nv.chucVu}</span>
												</p>
											</div>
											<div
												class=" col-4 d-flex flex-column justify-content-between">
												<p>
													Email: <span>${nv.email}</span>
												</p>
												<p>
						...
						<div
							class=" row m-0 p-3 ps-4 pe-4  d-flex justify-content-between">
								...
								<div class="row m-0 ">
									...
									<div
										...
										<a href="#"
											...
											class="fas fa-info vpp-text-pink " style="font-size: 2vw;"></i>
										</a>
								...
								<div class="row m-0 ">
									...
									<div
										...
										<a href="#"
											class=" d-flex align-items-center justify-content-center bg-white vpp-bd-circle p-2 m-1 mb-2 "
											style="height: 5vw; width: 5vw"> <i
											class="fas fa-check vpp-text-pink " style="font-size: 2vw;"></i>
										</a>
						...
						<h3 class="text-center m-4 mb-5">Sản phẩm bán chạy</h3>
						...
						<div id="demo" class="carousel slide" data-bs-ride="carousel">
											...
											<div class="card pb-2 vpp-bd-hover-pink vpp-bd-btn "
												...
												<div class="img-sp">
													<img class="card-img-top vpp-bd-radius-top"
														src="../resources/assets/img/sp/${sp.urlAnhSP}" alt="Card image"
							...
							<button class="carousel-control-prev" type="button"
								data-bs-target="#demo" data-bs-slide="prev" style="width: 5vw;">

								<i class="fas fa-chevron-circle-left fs-1"></i>
							</button>
							<button class="carousel-control-next" type="button"
								data-bs-target="#demo" data-bs-slide="next" style="width: 5vw;">
