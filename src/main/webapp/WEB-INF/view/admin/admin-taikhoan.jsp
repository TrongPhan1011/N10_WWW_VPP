			...
			<div class="row ">
				...
				<div class="col-10 p-0">
					<div class=" ps-2 vpp-bg-light-dark ">
						<a href="#" class="vpp-link">Chi tiết tài khoản</a> :
										...
										<form:form action="${ updateLink}" modelAttribute="thongtinNV"
											...
											<div class="row">
												...
												<div class="col-6">
													<div class="row  ">
														<div class="col-4">
															<label class="form-label" for="id-admin-manv"> Mã
																nhân viên: </label>
														</div>
														<div class="col-6 ">
													...
													<div class="row mt-3 ">
														...
														<div class="col-6 ">
															...
															<div class="invalid-feedback">Vui lòng điền tên
																nhân viên. Tên nhân viên không có ký tự đặt biệt và số</div>
														</div>
													</div>
													<div class="row mt-3 ">
														<div class="col-4">
														...
														<div class="col-6 ">
															...
															<div class="invalid-feedback">Vui lòng nhập số điện
																thoại. Số điện thoại gồm 10 ký tự số</div>
														</div>
													</div>
													<div class="row mt-3 ">
														<div class="col-4">
												...
												<div class="col-6">
													...
													<div class="row mt-3 ">
														...
														<div class="col-6 ">
															...
															<div class="invalid-feedback">Vui lòng điền mật
																khẩu mới</div>
														</div>
													</div>
