...
<c:url var="urlLoaiSP1" value="/sanpham/loaisanpham">
	...
	<div class="container-fluid vpp-bg-pink">
		...
		<div class="container">
			<div id="content  p-3 ps-5 pe-5">
				<div class="row">
					<div class="col-3 ">
						<div class="col-12 list-group-item vpp-bd-btn">
							<h4>Lọc sản phẩm</h4>
							<div class="fw-bold">Mức giá:</div>
							<select name="mucGia" id="mucGia" class="form-select mb-3">
								<option value="0">Tất cả</option>
								<option value="1">Dưới 20.000đ</option>
								<option value="2">20.000đ - 50.000đ</option>
								<option value="3">50.000đ - 100.000đ</option>
								<option value="4">100.000đ - 200.000đ</option>
								<option value="5">200.000đ - 500.000đ</option>
					...
					<div class="col-9 tk-bg  vpp-bd-btn ">
						<div class="row">
							<h4>Sản phẩm</h4>
						</div>
						<div class="row">
