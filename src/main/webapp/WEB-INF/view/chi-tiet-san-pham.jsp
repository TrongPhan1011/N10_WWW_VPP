    ...
    <div class="container-fluid vpp-bg-pink">
        ...
        <div class="row">
            <ul class="breadcrumb p-1 ps-5 pe-5">
                <li><a href="..//html/index.html" class="vpp-text-decoration vpp-link">Trang chủ</a></li><span>></span>
                        ...
                        <div id="chiTietSP" class="carousel slide bd-img" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner ">
                                <div class="carousel-item active ">
                                    <img src="..//assets/img/Slider/slide1.png" alt="img" class="d-block"
                                        style="width:100%;height:350px">
                                </div>
                                <div class="carousel-item ">
                                    <img src="..//assets/img/Slider/slide2.jpg" alt="img" class="d-block"
                                        style="width:100%;height:350px">
                                </div>
                                <div class="carousel-item">
                                    <img src="..//assets/img/Slider/slide3.jpg" alt="img" class="d-block"
                                        style="width:100%;height:350px">
                                </div>
                                <div class="carousel-item">
                                    <img src="..//assets/img/Slider/slide4.jpg" alt="img" class="d-block"
                                        style="width:100%;height:350px">
                                </div>
                            </div>
                ...
                <div class="row p-3 ps-5 vpp-bg-header">
                    <div class="col-5 ">
                        ...
                        <div class=" vpp-text-dark">
                            ...
                            <p class="fw-bold"><i class="fas fa-location-arrow me-2"></i>Địa chỉ: 12 Nguyễn Văn Bảo,
                                P.4, Gò
                                Vấp, TP. HCM</p>
