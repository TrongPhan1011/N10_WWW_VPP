                    ...
                    <div class="container-fluid vpp-bg-pink">
                        ...
                        <div class="row">
                            <ul class="breadcrumb p-1 ps-5 pe-5">
                                ...
                                <li><a href="#" class="vpp-text-decoration vpp-link">Sản phẩm</a></li><span>></span>
                                ...
                                <div class="row">
                                    <div class="col-6 p-5 pt-0">
                                        ...
                                        <div class="row d-flex justify-content-between mt-2 ">
                                            ...
                                            <img src="..//assets/img/Slider/slide3.jpg" alt="img" style="width:24%"
                                                data-bs-target="#chiTietSP" data-bs-slide-to="2" class="bd-img ">
                                            <img src="..//assets/img/Slider/slide4.jpg" alt="img" style="width:24%"
                                ...
                                <div class="row p-3 ps-5 vpp-bg-header">
                                    <div class="col-5 ">
                                        ...
                                        <div class=" vpp-text-dark">
                                            <p>Cung cấp các sản phẩm văn phòng phẩm chất lượng từ các thương hiệu hàng
                                                đầu.</p>
                                            <p class="fw-bold"><i class="fas fa-location-arrow me-2"></i>Địa chỉ: 12
                                                Nguyễn Văn Bảo,
                                                P.4, Gò
                                                Vấp, TP. HCM</p>
                                            <p class="fw-bold"><i class="fas fa-phone me-2"></i>Điện thoại: 099999999
                                            </p>
                                            <p class="fw-bold"><i class="fas fa-mail-bulk me-2"></i> Email:
                                                abcd@gmail.com</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class=" vpp-text-dark mt-3">
                                                ...
                                                <a href="#" class=" d-block vpp-link mb-2 vpp-text-decoration">Giới
                                                    thiệu</a>
                                                <a href="#" class="d-block mb-2 vpp-link vpp-text-decoration">Chính sách
                                                    đổi trả</a>
                                                <a href="#" class="d-block mb-2 vpp-link vpp-text-decoration">Điều khoản
                                                    dịch vụ</a>
                                                <a href="#" class="d-block mb-2 vpp-link vpp-text-decoration">Chính sách
                                                    bảo mật</a>
                                                <a href="#" class="d-block mb-2 vpp-link vpp-text-decoration">Liên
                                                    hệ</a>
                                    ...
                                    <div class="col-2 vpp-text-dark">
                                        <div class="mt-4">
                                            ...
                                            <div class=" vpp-text-dark mt-3">
                                                <a href="#" class=" d-block vpp-link mb-2 vpp-text-decoration">Tất cả
                                                    sản phẩm</a>
                                                <a href="#" class="d-block mb-2 vpp-link vpp-text-decoration">Khuyến
                                                    mãi</a>
                                            </div>
                                        </div>
