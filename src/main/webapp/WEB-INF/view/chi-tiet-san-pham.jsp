					...
					<div class="collapse navbar-collapse justify-content-center "
						...
						<ul class="navbar-nav">
							...
							<security:authorize access="hasAnyRole('EMPLOYEE','ADMIN')">
								<li class="nav-item"><a
									class="nav-link vpp-link fs-5 hvr-underline-from-center"
									href="${pageContext.request.contextPath}/admin/">Quản lý</a></li>
		...
		<div class="row">
			<ul class="breadcrumb p-1 ps-5 pe-5">
				<li><a href="..//html/index.html"
					class="vpp-text-decoration vpp-link">Trang chủ/</a></li>
			...
			<div id="content" class="vpp-bd-btn p-3 ps-5 pe-5">
				<div class="row">
					<div class="col-6 p-5 pt-0">
						<div id="chiTietSP" class="carousel slide bd-img"
						...
						<div class="row d-flex justify-content-between mt-2 ">
							...
							<img src="..//assets/img/Slider/slide1.png" alt="img"
								style="width: 24%" data-bs-target="#chiTietSP"
								data-bs-slide-to="0" class="active bd-img "> <img
								src="..//assets/img/Slider/slide2.jpg" alt="img"
								style="width: 24%" data-bs-target="#chiTietSP"
								data-bs-slide-to="1" class="bd-img"> <img
								src="..//assets/img/Slider/slide3.jpg" alt="img"
								style="width: 24%" data-bs-target="#chiTietSP"
								data-bs-slide-to="2" class="bd-img "> <img
								src="..//assets/img/Slider/slide4.jpg" alt="img"
								style="width: 24%" data-bs-target="#chiTietSP"
								data-bs-slide-to="3" class="bd-img  ">
					...
					<div class="col-6">
						...
						<button type="button"
							class="btn col-4   mt-4 border-warning btn-danger">Mua
							ngay</button>
						<button type="button" class="btn col-4  btn-success mt-4">Thêm
							vào giỏ</button>
					</div>
				</div>
				<div class="row">
