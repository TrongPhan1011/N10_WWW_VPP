                        ...
                        <div id="content" class="  p-3 ps-5 pe-5">
                            <div class="slider row m-0">
                                    ...
                                    <div id="slide" class="carousel scale" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner vpp-bd-btn">
                                            <div class="carousel-item vpp-bg-header ">
                                                <div
                                                    ...
                                                    <div class="col-12 ">
                                                        ...
                                                        <h5 class="vpp-text-dark">Chuyên cung cấp các sản phẩm văn phòng
                                                            phẩm</h5>
                                            ...
                                            <div class="carousel-item active ">
                                                <img src="./resources/assets/img/Slider/slide2.jpg" alt="imgSlide1"
                                                    class="d-block" style="width:100%">

                                            </div>
                                            <div class="carousel-item">
                                                <img src="./resources/assets/img/Slider/slide3.jpg" alt="imgSlide2"
                                                    class="d-block" style="width:100%">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="./resources/assets/img/Slider/slide5.jpg" alt="imgSlide1"
                                                    class="d-block" style="width:100%">
                                            </div>
                                        </div>
                                ...
                                <div class="col-4 text-center p-0 ps-3">
                                    ...
                                    <div class="row d-flex align-items-end imgSlide slide-block-sanpham hvr-grow"
                                        style="height: 15vw;">
                                        <div class="col-12 imgSlide p-0 ">
                                                    ...
                                                    <div class="card pb-2 vpp-bd-hover-pink vpp-bd-btn hvr-grow-shadow"
                                                        ...
                                                        <div class="img-sp">
                                                            <img class="card-img-top vpp-bd-radius-top"
                                                                src="./resources/assets/img/sp-${spNoiBac.id}/1"
                                            ...
                                            <c:forEach var="sp" items="${dsGiayIn}">
                                                <div class="col-3 pt-0 p-2 d-flex justify-content-around block-sanpham">
                                                    <div class="card pb-2 vpp-bd-hover-pink vpp-bd-btn hvr-grow-shadow"
                                                        ...
                                                        <div class="img-sp">
                                                            <img class="card-img-top vpp-bd-radius-top"
                                                                src="./resources/assets/img/sp-${sp.id}/1"
                                                                alt="Card image" style="width:100%; height: 9vw;">
                                                        </div>
                                                        <div class="card-body p-0">
                            ...
                            <div class="row p-3 ps-5 vpp-bg-header">
                                <div class="col-5 ">
                                    ...
                                    <div class=" vpp-text-dark">
                                        <p>Cung cấp các sản phẩm văn phòng phẩm chất lượng từ các thương hiệu hàng đầu.
                                        </p>
                                        <p class="fw-bold"><i class="fas fa-location-arrow me-2"></i>Địa chỉ: 12 Nguyễn
                                            Văn Bảo,
                                            P.4, Gò
                                            Vấp, TP. HCM</p>
                                        <p class="fw-bold"><i class="fas fa-phone me-2"></i>Điện thoại: 099999999</p>
                                        <p class="fw-bold"><i class="fas fa-mail-bulk me-2"></i> Email: abcd@gmail.com
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-2 vpp-text-dark">
                                    <div class="mt-4">
                                        ...
                                        <div class=" vpp-text-dark mt-3">
                                            <a href="${pageContext.request.contextPath}/sanpham"
                                                class=" d-block vpp-link mb-2 vpp-text-decoration">Tất cả sản
                                                phẩm</a>
