                    ...
                    <div id="slide" class="carousel scale" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner vpp-bd-btn">
                            ...
                            <div class="carousel-item active ">
                                <img src="./resources/assets/img/Slider/slide2.jpg" alt="imgSlide1" class="d-block"
                                    style="width:100%">

                            </div>
                            <div class="carousel-item">
                                <img src="./resources/assets/img/Slider/slide3.jpg" alt="imgSlide2" class="d-block"
                                    style="width:100%">
                            </div>
                            <div class="carousel-item">
                                <img src="./resources/assets/img/Slider/slide5.jpg" alt="imgSlide1" class="d-block"
                                    style="width:100%">
                            </div>
                        </div>
                ...
                <div class="col-4 text-center p-0 ps-3">
                    <div class="row d-flex  imgSlide slide-block-sanpham hvr-grow " style="height: 15vw;">
                        <div class="col-12 imgSlide p-0 ">
                            <img src="./resources/assets/img/Slider/slide4.jpg" alt="imgSlide" class="vpp-bd-btn imgSlide ">
                    ...
                    <div class="row d-flex align-items-end imgSlide slide-block-sanpham hvr-grow" style="height: 15vw;">
                        <div class="col-12 imgSlide p-0 ">
                            <img src="./resources/assets/img/Slider/slide1.png" alt="imgSlide" class="vpp-bd-btn imgSlide">
                            <div class=" align-items-end p-3 sub-sanpham imgSlide">
